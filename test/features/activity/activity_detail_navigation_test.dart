...
void main() {
  testWidgets('Tapping insights button opens InsightsPage', (WidgetTester tester) async {
    final provider = ActivityProvider();
    final a = Activity(name: 'Yoga', type: ActivityType.timeBased, unit: 'minutes');
    ...
    await tester.pumpWidget(MaterialApp(
      ...
      routes: {
        '/insights': (_) {
          ...
          return ChangeNotifierProvider<InsightsProvider>(create: (_) => InsightsProvider(repository: fake), child: const InsightsPage());
        }
      },
    ));
  });
