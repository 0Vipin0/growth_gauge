...
import 'package:growth_gauge/ui/workout/widgets/workout_templates_page.dart';
import 'package:provider/provider.dart';

void main() {
  testWidgets('WorkoutTemplatesPage shows create dialog and adds template',
      (WidgetTester tester) async {
    final provider = WorkoutTemplateProvider();

    await tester.pumpWidget(MaterialApp(
        home: ChangeNotifierProvider<WorkoutTemplateProvider>.value(
            value: provider, child: const WorkoutTemplatesPage())));
